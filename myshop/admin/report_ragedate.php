<form action="" method="get" class="form-horizontal">
    <h4>Chooes date for view report</h4>
    <div class="form-group">
        ...
        <div class="col-sm-1 ">
            <button type="submit" name="act" value="ragedate" class="btn btn-info">Search</button>
        </div>
    </div>
</form>
...
?>
<h4 align="center">Report of day</h4>
<p>Date Start : <?php echo date('d/m/Y',strtotime($ds));?>
    To : <?php echo date('d/m/Y',strtotime($de));?>
</p>
