  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-10">
        ...
        <a href="index.php" class="btn btn-warning ">Waiting for payment <span class="badge"><?php echo $rows1['s1total'];?></span></a>
        <a href="index.php?act=paid" class="btn btn-success ">Paid <span class="badge"><?php echo $rows2['s2total'];?></span></a>
        <a href="index.php?act=ems" class="btn btn-info ">EMS <span class="badge"><?php echo $rows3['s3total'];?></span></a>
        <a href="index.php?act=cancel" class="btn btn-danger ">Cancel <span class="badge"><?php echo $rows4['s4total'];?></span></a>
        <?php 
